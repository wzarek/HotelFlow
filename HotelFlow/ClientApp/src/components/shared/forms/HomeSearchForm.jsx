...
const SearchForm = () => {
  ...
  return (
    <form onClick={handleSearchSubmit} className='relative'>
      ...
      <div className='flex justify-between items-center my-[.5rem]'>
        ...
        <input defaultValue={2} className='w-[8em] bg-white p-[.5rem] rounded-lg text-black border-blue-600 border-solid border-[1.5px]' type='number' min={1} max={4} id='numPeople' name='numPeople' />
      </div>
