  ...
  return (
    ...
    <div className='h-[90vh] w-full flex flex-col justify-center gap-[5rem] items-center relative'>
      ...
      <form className="w-[25em] mr-[15%]" onSubmit={handleSubmit}>
        ...
        <button type="submit" id="submitButton" className="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center disabled:bg-gray-300">zaloguj</button>
        {
          error &&
