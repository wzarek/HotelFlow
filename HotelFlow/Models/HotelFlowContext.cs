...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-CJTGAEA;Database=HotelFlow;Trusted_connection=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ObjectPlacement>(entity =>
            {
                ...
                entity.Property(e => e.PositionFrom).HasMaxLength(1);

                entity.Property(e => e.PositionTo).HasMaxLength(1);
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.AddressLine1).HasMaxLength(1);

                entity.Property(e => e.AddressLine2).HasMaxLength(1);

                entity.Property(e => e.DateCreated).HasColumnType("datetime");

                entity.Property(e => e.EmailAddress).HasMaxLength(1);
